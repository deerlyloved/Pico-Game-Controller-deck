...
#define ENC_PPR 144                    // Encoder PPR
...
#define WS2812B_LED_SIZE 26           // Number of WS2812B LEDs
#define WS2812B_LED_ZONES 3           // Number of WS2812B LED Zones
...
const uint8_t SW_GPIO[] = {
    18, 16, 14, 12, 10, 8, 6, 20, 2, 22, 24, 4
};
const uint8_t LED_GPIO[] = {
    19, 17, 15, 13, 11, 9, 7, 21, 3, 23, 25, 5
};
