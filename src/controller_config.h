...
#define WS2812B_LED_SIZE 46           // Number of WS2812B LEDs
...
const uint8_t SW_KEYCODE[] = {HID_KEY_Z, HID_KEY_S, HID_KEY_X, HID_KEY_D,
                              ...
                              HID_KEY_ENTER, HID_KEY_TAB, HID_KEY_ESC};
const uint8_t SW_GPIO[] = {
    16, 14, 12, 10, 8, 6, 4, 18, 22, 24
};
const uint8_t LED_GPIO[] = {
    17, 15, 13, 11, 9, 7, 5, 19, 23, 25
};
const uint8_t ENC_GPIO[] = {26}; // (26, 27)
const bool ENC_REV[] = {false};  // Reverse Encoder
